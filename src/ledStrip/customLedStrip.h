...
struct BottomEQData {
    uint8_t red_right = 0; uint8_t green_right = 0; uint8_t blue_right = 0;
    uint8_t red_left  = 0; uint8_t green_left  = 0; uint8_t blue_left  = 0;
};
...
public:
    ...
    void flowDown(bool red = true, bool green = true, bool blue = true);
    void setBottomEQ(BottomEQData);
};
